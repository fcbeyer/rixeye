...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { author: @commit.author, commmitted_at: @commit.commmitted_at, issue: @commit.issue, message: @commit.message, revision: @commit.revision }
    end
  ...
  test "should update commit" do
    put :update, id: @commit, commit: { author: @commit.author, commmitted_at: @commit.commmitted_at, issue: @commit.issue, message: @commit.message, revision: @commit.revision }
    assert_redirected_to commit_path(assigns(:commit))
  end
