...
class PathsControllerTest < ActionController::TestCase
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post :create, path: { action: @path.action, commits_id: @path.commits_id, file: @path.file, kind: @path.kind }
    end
  ...
  test "should update path" do
    put :update, id: @path, path: { action: @path.action, commits_id: @path.commits_id, file: @path.file, kind: @path.kind }
    assert_redirected_to path_path(assigns(:path))
  end
